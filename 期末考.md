...
- 用途 ==>網際網路上標準的資源的位址（Address），如同在網路上的門牌
...
- ksu.edu.tw ==>網域
- my.ksu.edu.tw ==>伺服器位址
- file/web/CHT/DAAACIS/b38de400-d78b-46c8-a922-993cfeffe5f4.pdf=>路徑名稱
...
## Ip address
- 用途 ==>是網際協定中用於標識傳送或接收資料報的裝置的一串數字
- 組成 ==>分為 IPv4 與 IPv6 兩大類，IP位址由一串數字組成。IPv4 由十進位數字組成，並以點分隔，如：172.16.254.1 ； IPv6 由十六進位數字組成，以冒號分割，如：2001:db8:0:1234:0:567:8:1 
- 32 bits
